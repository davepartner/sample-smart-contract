...
//use latest solidity version at the time of this writing
...
contract Token{
    ...
    //that is, be able to tell which addresses own which supply
    mapping(address => uint256) public balanceOf;
    mapping(address => mapping(address => uint256)) public allowance;

    //Events - fire events on state changes etc 
    event Transfer(address indexed from, address indexted to, uint256 value);
    ...
    constructor(string memory _name, string memory _symbol, uint256 _decimals, uint256 _totalSupply){
         ...
         //once smart contract is deployed, allocate all tokens to this address
    ...
    /// @notice transfer amount of tokens to an address 
     ...
     /// @notice Aprove other to spend on your behalf eg. an exchange 
     ...
     function approve (address _spender, uint256 _value) external returns (bool){
          require (_spender != address(0)); //spending address must be valid
     ...
     // Allow _spender to spend up to the _value on your behalf 
